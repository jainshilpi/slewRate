...
static constexpr auto s_tag = "[ECALTimeSampleAnalyser]";

TEST_CASE("Standard checks of ECALTimeSampleAnalyser", s_tag) {
  const std::string baseConfig{
      R"_(from FWCore.TestProcessor.TestProcess import *
process = TestProcess()
process.toTest = cms.EDProducer("ECALTimeSampleAnalyser"
